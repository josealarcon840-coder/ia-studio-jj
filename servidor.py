...
MODELS = [
    ...
    # 🔴 TEXTURAS ULTRA DEFINIDAS PARA LA WEB
    {"slug": "textile-styles", "label": L("Texturas Mágicas 3D", "3D Magic Textures"), "icon": "fa-cubes", "category": L("5. Belleza y Edición", "5. Beauty & Edit"), "desc": L("Aplica lana, bordado, parche o globo.", "Applies yarn, thread, patch or puffy textures."), "endpoint": "/v1/images/edits", "response_type": "image", "fields": [
        ...
        {"name": "prompt", "type": "select", "label": L("Elige la Textura", "Select Texture"), "required": True, "options": [
            {"value": "Apply a highly detailed 3D amigurumi crochet texture. Create thick, visible, realistic knitted yarn loops. CRITICAL: Keep EXACT original colors and shapes. Do NOT invent colors. If transparent, strictly preserve transparency.", "label": L("🧶 Crochet / Amigurumi (Lana)", "Crochet / Amigurumi")},
            {"value": "Apply a highly detailed realistic embroidery texture. Create thick, glossy, visible 3D thread stitches. CRITICAL: Keep EXACT original colors. Do NOT invent colors. If transparent, strictly preserve transparency.", "label": L("🧵 Bordado Realista (Hilos 3D)", "Realistic Embroidery")},
            {"value": "Apply a realistic 3D embroidered patch style. CRITICAL: Add a thick, dense embroidered border outline around the outer edges of the subject. Fill the inside with realistic shiny embroidery threads matching the EXACT original colors. If transparent, PRESERVE transparency outside the patch border.", "label": L("🏷️ Parche Textil (Borde Grueso)", "Textile Patch")},
            {"value": "Apply 3D inflated balloon puffy texture. Make elements look like thick, soft, highly glossy 3D plastic or vinyl. CRITICAL: Keep EXACT original colors. If transparent, strictly preserve transparency.", "label": L("🎈 Estilo Inflado 3D (Globo/Puffer)", "3D Inflated/Puffer")}
        ]}
    ]},
