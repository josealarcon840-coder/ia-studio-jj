...
MODELS = [
    ...
    # 🔴 OPCIONES SEPARADAS: Textura Limpia vs Estilo Estudio (Con Sombras/Viñeta)
    {"slug": "textile-styles", "label": L("Texturas Mágicas 3D", "3D Magic Textures"), "icon": "fa-cubes", "category": L("5. Belleza y Edición", "5. Beauty & Edit"), "desc": L("Aplica lana, bordado, parche o estudio.", "Applies yarn, thread, patch or study styles."), "endpoint": "/v1/images/edits", "response_type": "image", "fields": [
        ...
        {"name": "prompt", "type": "select", "label": L("Elige el Estilo", "Select Style"), "required": True, "options": [
            {"value": "Apply a clean 3D amigurumi crochet texture only on the subject. Strictly preserve original colors. Keep transparent background completely clean without dark glows or vignetting.", "label": L("🧶 Crochet Limpio (Sin Sombra)", "Clean Crochet")},
            {"value": "Apply a clean realistic embroidery texture on the subject. Keep original colors. Preserve transparent background completely clean without background shadows or lighting effects.", "label": L("🧵 Bordado Limpio (Sin Sombra)", "Clean Embroidery")},
            {"value": "Convert this exact design into a clean 3D embroidered patch with an embroidered border. Keep original colors. Preserve transparent background without dark glows or vignettes.", "label": L("🏷️ Parche Limpio (Sin Sombra)", "Clean Patch")},
            {"value": "Apply a detailed 3D amigurumi crochet texture with professional photo studio lighting, dramatic dark vignette and soft glowing background shadows.", "label": L("📸 Crochet Estilo Estudio (Con Sombra/Viñeta)", "Studio Crochet with Vignette")}
        ]}
    ]},
