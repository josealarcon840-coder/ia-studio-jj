...
MODELS = [
    ...
    # 🔴 AQUI ESTAN LOS PROMPTS ESTRICTOS EN LA WEB PARA MANTENER COLORES
    {"slug": "textile-styles", "label": L("Texturas Mágicas 3D", "3D Magic Textures"), "icon": "fa-cubes", "category": L("5. Belleza y Edición", "5. Beauty & Edit"), "desc": L("Aplica lana, hilo o estilo inflado 3D.", "Applies yarn, thread or puffy textures."), "endpoint": "/v1/images/edits", "response_type": "image", "fields": [
        ...
        {"name": "prompt", "type": "select", "label": L("Elige la Textura", "Select Texture"), "required": True, "options": [
            {"value": "Apply 3D amigurumi crochet texture. CRITICAL INSTRUCTION: You MUST keep the EXACT original colors, exact original palette, and exact background. DO NOT change or invent any new colors. Only apply a knitted yarn texture to the existing image using the exact original colors.", "label": L("🧶 Crochet / Amigurumi (Lana)", "Crochet / Amigurumi")},
            {"value": "Apply highly detailed realistic embroidery patch texture. CRITICAL INSTRUCTION: You MUST use threads that EXACTLY match the original colors of the image. DO NOT use random colored threads. DO NOT change the color palette. Keep the exact original background and transparent areas. Just change the surface material to stitched thread matching the original colors.", "label": L("🧵 Bordado Realista (Hilos 3D)", "Realistic Embroidery")},
            {"value": "Apply 3D inflated balloon puffy texture. CRITICAL INSTRUCTION: You MUST keep the EXACT original colors and exact original palette. DO NOT change or invent any new colors. Make the existing elements look like soft, puffy, glossy plastic or vinyl with identical original colors.", "label": L("🎈 Estilo Inflado 3D (Globo/Puffer)", "3D Inflated/Puffer")}
        ]}
    ]},
