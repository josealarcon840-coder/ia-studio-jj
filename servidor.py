...
def download_image():
    ...
    try:
        ...
        return Response(buf.getvalue(), mimetype="image/png", headers={"Content-Disposition": "attachment; filename=JJ_Studio_HQ_300DPI.png"})
...
def run_model(slug):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            return jsonify({"error": True, "message": f"Código {response.status_code} | Detalle: {response.text}"}), 400
